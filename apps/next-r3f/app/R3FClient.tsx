...
export default function R3FClient(): ReactNode {
  ...
  return (
    <main className="harness-root">
      ...
      >
        <p className="hint">R3F는 <code>dynamic(..., &#123; ssr: false &#125;)</code>로 browser-only WebGL 경계를 만들고, Next route handler에서 fixture를 제공합니다.</p>
      </HarnessPanel>
    </main>
  );
}
